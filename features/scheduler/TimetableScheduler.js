...
const Modal = ({ isOpen, onClose, title, children = null, error = null }) => {
...
const SetupTab = ({ classes, faculty, subjects, rooms, openModal, handleDelete, handleResetData, selectedItems, onToggleSelect, onToggleSelectAll, onInitiateBulkDelete, pageError }) => {
...
const ConstraintsTab = ({ constraints, onConstraintsChange, classes, subjects, faculty }) => {
    const uniqueDepartments = useMemo(() => [...new Set(faculty.map(f => f.department))], [faculty]);

    const handleConstraintUpdate = (updater) => {
            ...
            React.createElement("div", { className: "space-y-6 max-w-lg" },
                React.createElement("div", null,
                    ...
                    React.createElement("input", {
                        ...
                        onChange: (e) => handleConstraintUpdate(c => ({...c, maxConsecutiveClasses: parseInt(e.target.value, 10)})),
                    ...
                    if (constraint.type === 'nonConsecutive') {
                        return React.createElement("div", { key: constraint.id, className: "flex flex-wrap items-center gap-2 p-3 bg-gray-100 dark:bg-slate-900/50 rounded-lg" },
                             React.createElement("select", {
                                ...
                                onChange: (e) => handleConstraintChange(constraint.id, 'classId', e.target.value),
                            ...
                            React.createElement("select", {
                                ...
                                onChange: (e) => handleConstraintChange(constraint.id, 'subjectId1', e.target.value),
                                className: "p-2 border border-gray-300 dark:border-slate-600 bg-gray-50 dark:bg-slate-800 rounded-md text-gray-800 dark:text-gray-200"
                            ...
                            React.createElement("select", {
                                ...
                                onChange: (e) => handleConstraintChange(constraint.id, 'subjectId2', e.target.value),
                                className: "p-2 border border-gray-300 dark:border-slate-600 bg-gray-50 dark:bg-slate-800 rounded-md text-gray-800 dark:text-gray-200"
                            }, React.createElement("option", { value: "" }, "Select Subject"), ...subjectOptions),
                         ...
                         return React.createElement("div", { key: constraint.id, className: "flex flex-wrap items-center gap-2 p-3 bg-gray-100 dark:bg-slate-900/50 rounded-lg" },
                            ...
                            React.createElement("select", {
                                ...
                                onChange: (e) => handleConstraintChange(constraint.id, 'timePreference', e.target.value),
                                className: "p-2 border border-gray-300 dark:border-slate-600 bg-gray-50 dark:bg-slate-800 rounded-md text-gray-800 dark:text-gray-200"
                            ...
                            React.createElement("select", {
                                ...
                                onChange: (e) => handleConstraintChange(constraint.id, 'day', e.target.value),
                                className: "p-2 border border-gray-300 dark:border-slate-600 bg-gray-50 dark:bg-slate-800 rounded-md text-gray-800 dark:text-gray-200"
                            }, ...dayOptions),
                            deleteButton
                        );
                         ...
                         return React.createElement("div", { key: constraint.id, className: "flex flex-wrap items-center gap-2 p-3 bg-gray-100 dark:bg-slate-900/50 rounded-lg" },
                             React.createElement("select", {
                                ...
                                onChange: (e) => handleConstraintChange(constraint.id, 'facultyId', e.target.value),
                                className: "p-2 border border-gray-300 dark:border-slate-600 bg-gray-50 dark:bg-slate-800 rounded-md text-gray-800 dark:text-gray-200"
                            ...
                            React.createElement("select", {
                                ...
                                onChange: (e) => handleConstraintChange(constraint.id, 'timeSlot', e.target.value),
                                className: "p-2 border border-gray-300 dark:border-slate-600 bg-gray-50 dark:bg-slate-800 rounded-md text-gray-800 dark:text-gray-200"
                            }, ...timeSlotOptions),
                            deleteButton
                        );
...
const GenerateTab = ({ onGenerate, isLoading, error, loadingMessage }) => (
...
const ViewTab = ({ timetable }) => {
    ...
    const getEntries = useCallback((day, time) => {
    ...
    return (
        React.createElement(SectionCard, { title: "Generated Timetable" },
            React.createElement("div", { className: "flex flex-wrap gap-4 mb-6 items-center" },
                 React.createElement("select", { value: viewBy, onChange: (e) => setViewBy(e.target.value), className: "p-2 border border-gray-300 dark:border-slate-600 bg-gray-50 dark:bg-slate-700 rounded-md text-gray-800 dark:text-white" },
...
export const TimetableScheduler = ({ onLogout, theme, toggleTheme, classes, faculty, subjects, rooms, students, constraints, setConstraints, onSaveEntity, onDeleteEntity, onResetData, token }) => {
  ...
  const [modalState, setModalState] = useState({ isOpen: false, mode: 'add', type: '', data: null, error: null });
  const [isConfirmModalOpen, setIsConfirmModalOpen] = useState(false);
  const [confirmSingleDelete, setConfirmSingleDelete] = useState({ isOpen: false, onConfirm: () => {} });
  ...
  const openModal = (mode, type, data = null) => setModalState({ isOpen: true, mode, type, data, error: null });
