...
export const LoginPage = ({ onLogin }: LoginPageProps) => {
    ...
    React.createElement("div", null,
      ...
      React.createElement("form", { onSubmit: handleSubmit, className: "space-y-6" },
        React.createElement("div", null,
          ...
          React.createElement("input", { type: "text", id: "username", placeholder: "Enter your username or email", value: username, onChange: (e: React.ChangeEvent<HTMLInputElement>) => setUsername(e.target.value), className: "mt-1 block w-full px-4 py-3 bg-white/50 dark:bg-slate-900/50 border border-gray-300 dark:border-slate-700 text-gray-800 dark:text-gray-100 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition", required: true, disabled: isLoading })
        ),
        React.createElement("div", null,
    ...
    React.createElement("div", null,
        ...
        :
            React.createElement("form", { onSubmit: handleResetPassword, className: "space-y-4" },
                React.createElement("input", { type: "text", name: "otp", placeholder: "Enter OTP", value: forgotPasswordState.otp, onChange: handleForgotPasswordChange, className: "block w-full px-4 py-3 bg-white/50 dark:bg-slate-900/50 border border-gray-300 dark:border-slate-700 rounded-lg", required: true, disabled: isLoading }),
                React.createElement("input", { type: "password", name: "newPassword", placeholder: "New Password", value: forgotPasswordState.newPassword, onChange: handleForgotPasswordChange, className: "block w-full px-4 py-3 bg-white/50 dark:bg-slate-900/50 border border-gray-300 dark:border-slate-700 rounded-lg", required: true, disabled: isLoading }),
  ...
  return (
    React.createElement("div", { className: "min-h-screen flex items-center justify-center bg-transparent p-4" },
      React.createElement("div", { className: "w-full max-w-md bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-gray-200 dark:border-slate-700" },
